...
export function VerifyAccountPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setError(null)
    try {
      await api.post('/auth/verify-account', { token, new_password: password })
      toast.success('Account verified! Please sign in.')
      navigate('/login')
    } catch (err: any) {
      setError(apiError(err, 'Verification failed. The link may have expired.'))
    } finally {
      setLoading(false)
    }
  }
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6">
        <div className="text-center">
          ...
          <p className="text-gray-500 text-sm mb-6">This link is missing a token. Ask your admin to resend your invite.</p>
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
          <div className="mb-6">
            ...
            <p className="text-gray-500 mt-1 text-sm">Set a password to activate your account and confirm it's really you.</p>
          </div>
