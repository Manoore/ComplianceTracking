...
def _apply_migrations():
    ...
    stmts = [
        ...
        "ALTER TABLE org_settings ADD COLUMN compliance_green_threshold INTEGER DEFAULT 90",
        "ALTER TABLE org_settings ADD COLUMN compliance_amber_threshold INTEGER DEFAULT 80",
    ]
    for stmt in stmts:
